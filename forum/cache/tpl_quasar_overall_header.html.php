...
<!--[if IE 6]>
<link href="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/joomla-ie6.css" rel="stylesheet" type="text/css" media="screen, projection"  />
<![endif]-->
...
#rt-body-surround .rt-container,#rt-footer .rt-container,#rt-copyright .rt-container {
   width: 97%;
}

#rt-body-surround .rt-container .rt-grid-12 {
   width: 99%;
}

#rt-bottom .rt-grid-4,#rt-footer .rt-grid-4 {
	width: 32%;
}
...
<script type="text/javascript">
window.addEvent('domready', function() {
  var newImagePath = '<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>styles/quasar_red_imageset/imageset/'; // remember to add the ending forward slash
...
<script type="text/javascript">
window.addEvent('domready', function() {
  var newImagePath = '<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>styles/quasar_green_imageset/imageset/'; // remember to add the ending forward slash
  var classToSearch = 'li.row dl.icon';
  var els = $$(classToSearch);
  if (els.length) {
    els.each(function(el) {
    ...
    <div id="rt-top2">
        ...
        <div class="rt-grid-<?php if ($this->_rootref['S_DISPLAY_SEARCH'] && ! $this->_rootref['S_IN_SEARCH']) {  ?>3<?php } else { ?>6<?php } ?> rt-omega">
			...
			<div id="rt-accessibility">
				...
				<div id="rt-buttons">
<a href="#" onclick="fontsizeup(); return false;" onkeypress="fontsizeup(); return false;" title="<?php echo ((isset($this->_rootref['L_CHANGE_FONT_SIZE'])) ? $this->_rootref['L_CHANGE_FONT_SIZE'] : ((isset($user->lang['CHANGE_FONT_SIZE'])) ? $user->lang['CHANGE_FONT_SIZE'] : '{ CHANGE_FONT_SIZE }')); ?>" class="large"><span class="button"></span></a>
<a href="#" onclick="fontsizedown(); return false;" onkeypress="fontsizedown(); return false;"  title="<?php echo ((isset($this->_rootref['L_CHANGE_FONT_SIZE'])) ? $this->_rootref['L_CHANGE_FONT_SIZE'] : ((isset($user->lang['CHANGE_FONT_SIZE'])) ? $user->lang['CHANGE_FONT_SIZE'] : '{ CHANGE_FONT_SIZE }')); ?>" class="small"><span class="button"></span></a>
				</div>
			</div>
			<div class="clear"></div>
		</div>
...
<?php } if ($this->_rootref['S_DISPLAY_SEARCH'] && ! $this->_rootref['S_IN_SEARCH']) {  ?>
     ...
     <div class="rt-grid-4 rt-omega">
	  ...
	  <div class="search">
          ...
          </div><input type="hidden" name="task" value="search" /> <input type="hidden" name="option" value="com_search" /> <input type="hidden" name="Itemid" value="54" />
        </fieldset> 
	</form>
        </div>
       </div>
     ...
     <div id="rt-header3">
      <div id="rt-header4">
       <div class="rt-grid-2 rt-alpha">
        <div class="rt-block">
        	<a href="<?php if ($this->_tpldata['DEFINE']['.']['QUASAR_LOGO_LINK']) {  echo (isset($this->_tpldata['DEFINE']['.']['QUASAR_LOGO_LINK'])) ? $this->_tpldata['DEFINE']['.']['QUASAR_LOGO_LINK'] : ''; } else { echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; } ?>" id="rt-logo"></a> 
        </div>
       </div>
        ...
        <div class="_menu">
         <div class="rt-block">
          <div class="module-surround">
           ...
           <div class="module-content">			
									  <ul class="menu">
<li class="item1 root"><a class="orphan item" href="http://www.crimson-alliance.com" accesskey="h"><span>Home</span></a></li>
<li class="item1 root"><a class="orphan item" href="http://www.crimson-alliance.com/calendar.php" accesskey="h"><span>Calendar</span></a></li>
<li class="item1 root"><a class="orphan item" href="http://www.crimson-alliance.com/suicide.php" accesskey="h"><span>Suicide</span></a></li>
<li class="item1 <?php if ($this->_rootref['SCRIPT_NAME'] == ('index')) {  ?>active<?php } ?> root"><a class="orphan item" href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="h"><span>Forums</span></a></li>
...
<li class="item2 root"><a href="http://www.crimson-alliance.com/members.php" title="<?php echo ((isset($this->_rootref['L_MEMBERLIST_EXPLAIN'])) ? $this->_rootref['L_MEMBERLIST_EXPLAIN'] : ((isset($user->lang['MEMBERLIST_EXPLAIN'])) ? $user->lang['MEMBERLIST_EXPLAIN'] : '{ MEMBERLIST_EXPLAIN }')); ?>" class="orphan item bullet"><span>Members</span></a></li>
        
<?php if (! $this->_rootref['S_IS_BOT']) {  if (! $this->_rootref['S_USER_LOGGED_IN']) {  ?>

<li class="item4 <?php if ($this->_rootref['S_UCP_ACTION'] == ('./ucp.php?mode=register')) {  ?>active<?php } ?> root"><a class="orphan item bullet" href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><span><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></span></a></li>
<?php } ?>
...
<a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" id="breadcrumbs-home"></a><span class="breadcrumbs pathway">
<span><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a></span><?php $_navlinks_count = (isset($this->_tpldata['navlinks'])) ? sizeof($this->_tpldata['navlinks']) : 0;if ($_navlinks_count) {for ($_navlinks_i = 0; $_navlinks_i < $_navlinks_count; ++$_navlinks_i){$_navlinks_val = &$this->_tpldata['navlinks'][$_navlinks_i]; ?> <img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/arrow.png" alt=""  /><a href="<?php echo $_navlinks_val['U_VIEW_FORUM']; ?>"><?php echo $_navlinks_val['FORUM_NAME']; ?></a><?php }} ?></span>
					</div>
