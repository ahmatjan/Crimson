<?php exit; ?>
1379683284
SELECT s.style_id, c.theme_id, c.theme_data, c.theme_path, c.theme_name, c.theme_mtime, i.*, t.template_path FROM phpbb_styles s, phpbb_styles_template t, phpbb_styles_theme c, phpbb_styles_imageset i WHERE s.style_id = 17 AND t.template_id = s.template_id AND c.theme_id = s.theme_id AND i.imageset_id = s.imageset_id
81535
a:1:{i:0;a:11:{s:8:"style_id";s:2:"17";s:8:"theme_id";s:2:"16";s:10:"theme_data";s:81106:"/*  phpBB3 Style Sheet
    --------------------------------------------------------------
...
html, body {
	color: #536482;
	background: url("{T_THEME_PATH}/images/background.png") repeat;
}
...
.icon-faq						{ background-image: url("{T_THEME_PATH}/images/faqc.png"); }
.icon-members					{ background-image: url("{T_THEME_PATH}/images/groups.png"); }
.icon-home						{ background-image: url("{T_THEME_PATH}/images/housec.png"); }
.icon-ucp						{ background-image: url("{T_THEME_PATH}/images/user_edit.png"); }
.icon-register					{ background-image: url("{T_THEME_PATH}/images/add.png"); }
.icon-logout					{ background-image: url("{T_THEME_PATH}/images/session.png"); }
...
/* Custom icon images */
.icon-message					{ background-image: url("{T_THEME_PATH}/images/mail.png"); }
.icon-self					{ background-image: url("{T_THEME_PATH}/images/selfsearch.png"); }
...
.onlinestat {
	background-image: url("{T_THEME_PATH}/images/group.png");
	background-repeat: no-repeat;
	padding-left: 40px;
	margin-left: 4px;
}
...
.stats {
	background-image: url("{T_THEME_PATH}/images/statistics.png");
	background-repeat: no-repeat;
	padding-left: 40px;
	height: 40px;
	margin-left: 4px;
...
.birth {
	background-image: url("{T_THEME_PATH}/images/birth.png");
	background-repeat: no-repeat;
	padding-left: 40px;
	margin-left: 4px;
}
...
.login {
	background-image: url("{T_THEME_PATH}/images/login.png");
	background-repeat: no-repeat;
	padding-left: 40px;
	margin-top: -10px;
	height: 40px;
...
.section-memberlist h2 { padding-bottom: 4px;}";s:10:"theme_path";s:10:"myInvision";s:10:"theme_name";s:10:"myInvision";s:11:"theme_mtime";s:10:"1379002919";s:11:"imageset_id";s:2:"16";s:13:"imageset_name";s:10:"myInvision";s:18:"imageset_copyright";s:47:"&copy; Brad Veryard ( http://www.bradleyv.com )";s:13:"imageset_path";s:10:"myInvision";s:13:"template_path";s:10:"myInvision";}}