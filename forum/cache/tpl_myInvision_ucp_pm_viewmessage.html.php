...
<div class="pannels">
<div id="post-<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>" class="post<?php if ($this->_rootref['S_POST_UNAPPROVED'] || $this->_rootref['S_POST_REPORTED']) {  ?> reported<?php } ?>">
<div class="inner">
	<div class="postbody">
	...
	<dl class="postprofile<?php if ($this->_rootref['S_ONLINE']) {  ?> online<?php } ?>" id="profile<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>">
