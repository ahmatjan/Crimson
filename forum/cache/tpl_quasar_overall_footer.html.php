...
<div>
  ...
  <div class="clear"></div>
       ...
       <?php if ($this->_tpldata['DEFINE']['.']['QUASAR_MENUPOSITION'] == (right) || $this->_tpldata['DEFINE']['.']['QUASAR_MENUPOSITION'] == (left)) {  ?>

                                <div class="rt-grid-4 <?php if ($this->_tpldata['DEFINE']['.']['QUASAR_MENUPOSITION'] == (left)) {  ?>rt-pull-8<?php } ?> " >
                <div id="rt-sidebar-a"> 
                    <div class="rt-block"> 
				<div class="module-surround"> 
	                					<div class="module-title"><h2 class="title"><?php echo (isset($this->_tpldata['DEFINE']['.']['MAIN_MENU'])) ? $this->_tpldata['DEFINE']['.']['MAIN_MENU'] : ''; ?></h2></div> 
	...
	<?php if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?>
		...
		<li class="parent <?php if ($this->_rootref['S_SEARCH_ACTION'] == ('./search.php?st=0&amp;sk=t&amp;sd=d&amp;sr=topics&amp;search_id=unanswered')) {  ?>active<?php } ?>"><a href="<?php echo (isset($this->_rootref['U_SEARCH_UNANSWERED'])) ? $this->_rootref['U_SEARCH_UNANSWERED'] : ''; ?>" ><span><?php echo ((isset($this->_rootref['L_SEARCH_UNANSWERED'])) ? $this->_rootref['L_SEARCH_UNANSWERED'] : ((isset($user->lang['SEARCH_UNANSWERED'])) ? $user->lang['SEARCH_UNANSWERED'] : '{ SEARCH_UNANSWERED }')); ?></span></a></li><?php if ($this->_rootref['S_USER_LOGGED_IN']) {  ?>

		<li class="parent <?php if ($this->_rootref['S_SEARCH_ACTION'] == ('./search.php?&amp;sr=topics&amp;search_id=newposts')) {  ?>active<?php } ?>"><a href="<?php echo (isset($this->_rootref['U_SEARCH_NEW'])) ? $this->_rootref['U_SEARCH_NEW'] : ''; ?>" ><span><?php echo ((isset($this->_rootref['L_SEARCH_NEW'])) ? $this->_rootref['L_SEARCH_NEW'] : ((isset($user->lang['SEARCH_NEW'])) ? $user->lang['SEARCH_NEW'] : '{ SEARCH_NEW }')); ?></span></a></li><?php } ?>

		<li class="parent <?php if ($this->_rootref['S_SEARCH_ACTION'] == ('./search.php?st=7&amp;sk=t&amp;sd=d&amp;sr=topics&amp;search_id=active_topics')) {  ?>active<?php } ?>"><a href="<?php echo (isset($this->_rootref['U_SEARCH_ACTIVE_TOPICS'])) ? $this->_rootref['U_SEARCH_ACTIVE_TOPICS'] : ''; ?>" ><span><?php echo ((isset($this->_rootref['L_SEARCH_ACTIVE_TOPICS'])) ? $this->_rootref['L_SEARCH_ACTIVE_TOPICS'] : ((isset($user->lang['SEARCH_ACTIVE_TOPICS'])) ? $user->lang['SEARCH_ACTIVE_TOPICS'] : '{ SEARCH_ACTIVE_TOPICS }')); ?></span></a></li>
	<?php } ?>

	<li class="<?php if ($this->_rootref['S_SEARCH_ACTION'] == ('./search.php?st=0&amp;sk=t&amp;sd=d&amp;sr=topics&amp;author_id=2')) {  ?>active<?php } ?>"><a href="<?php echo (isset($this->_rootref['U_SEARCH_SELF'])) ? $this->_rootref['U_SEARCH_SELF'] : ''; ?>" ><span><?php echo ((isset($this->_rootref['L_SEARCH_SELF'])) ? $this->_rootref['L_SEARCH_SELF'] : ((isset($user->lang['SEARCH_SELF'])) ? $user->lang['SEARCH_SELF'] : '{ SEARCH_SELF }')); ?></span></a></li>
	<li class="<?php if ($this->_rootref['S_SEARCH_ACTION'] == ('./search.php')) {  ?>active<?php } ?>"><a href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SEARCH_ADV_EXPLAIN'])) ? $this->_rootref['L_SEARCH_ADV_EXPLAIN'] : ((isset($user->lang['SEARCH_ADV_EXPLAIN'])) ? $user->lang['SEARCH_ADV_EXPLAIN'] : '{ SEARCH_ADV_EXPLAIN }')); ?>" ><span><?php echo ((isset($this->_rootref['L_SEARCH_ADV'])) ? $this->_rootref['L_SEARCH_ADV'] : ((isset($user->lang['SEARCH_ADV'])) ? $user->lang['SEARCH_ADV'] : '{ SEARCH_ADV }')); ?></span></a></li>
...
<?php } ?>
                    ...
                    <div class="rt-block"> 
				<div class="module-surround"> 
	                					<div class="module-title"><h2 class="title"><?php echo (isset($this->_tpldata['DEFINE']['.']['USER_MENU'])) ? $this->_tpldata['DEFINE']['.']['USER_MENU'] : ''; ?></h2></div> 
	                					<div class="module-content"> 
	       	<ul class="menu">
	<?php if ($this->_rootref['U_MCP']) {  ?><li <?php if ($this->_rootref['SCRIPT_NAME'] == ('mcp')) {  ?>class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_MCP'])) ? $this->_rootref['U_MCP'] : ''; ?>" ><span><?php echo ((isset($this->_rootref['L_MCP'])) ? $this->_rootref['L_MCP'] : ((isset($user->lang['MCP'])) ? $user->lang['MCP'] : '{ MCP }')); ?></span></a></li><?php } if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?>
				...
				<li <?php if ($this->_rootref['SCRIPT_NAME'] == ('ucp')) {  ?>class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_PROFILE'])) ? $this->_rootref['U_PROFILE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?>" accesskey="u" ><span><?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?></span></a></li>
						<?php if ($this->_rootref['S_DISPLAY_PM']) {  ?><li><a href="<?php echo (isset($this->_rootref['U_PRIVATEMSGS'])) ? $this->_rootref['U_PRIVATEMSGS'] : ''; ?>" ><span><?php echo (isset($this->_rootref['PRIVATE_MESSAGE_INFO'])) ? $this->_rootref['PRIVATE_MESSAGE_INFO'] : ''; ?></span></a></li><?php } if ($this->_rootref['U_RESTORE_PERMISSIONS']) {  ?>
             ...
             <div class="rt-block"> 
				<div class="module-surround"> 
	                	<div class="module-title"><h2 class="title"><?php echo ((isset($this->_rootref['L_LOGIN'])) ? $this->_rootref['L_LOGIN'] : ((isset($user->lang['LOGIN'])) ? $user->lang['LOGIN'] : '{ LOGIN }')); ?></h2></div> 
                                <div class="module-content"> 
	                	<form method="post" action="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>ucp.php?mode=login" id="form-login">
			...
			<label class="remember">
				<?php echo ((isset($this->_rootref['L_LOG_ME_IN'])) ? $this->_rootref['L_LOG_ME_IN'] : ((isset($user->lang['LOG_ME_IN'])) ? $user->lang['LOG_ME_IN'] : '{ LOG_ME_IN }')); ?>
 ...
 <?php } ?>
   ...
   <div class="rt-container">
    ...
    <div class="rt-block">
     <div class="bottomtab">
      <span class="bottomtab2"><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?></span>
     </div>
    </div>
    <div class="clear"></div>
   </div>
